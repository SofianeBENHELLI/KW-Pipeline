/**
 * Knowledge Forge Settings — explorer surface.
 *
 * Same data layer as the widget settings tile and the web modal (see
 * ``apps/_shared/settings-hub``). Mounted as a centred overlay
 * triggered by a gear button in the explorer's header. The explorer
 * does not let users mutate the API base URL — the widget tile is
 * the surface where end users override it on a per-tile basis.
 */
